  ...
  return (
    <div id="partnership-clientela">
      <div className="container mx-auto">
        <SectionHeader2 topText="TRAGUARDI" title="Esplora nuova" highlightedText="clientela" />
      </div>
        ...
        <div className="container mx-auto">
          <div className="flex flex-row overflow-x-auto gap-6 scrollbar-hide">
            ...
            <div className="bg-white px-20 lg:w-[255px] h-[170px] shadow-lg border rounded-xl p-6 flex flex-col items-center text-center mb-4">
              <Image src={client} alt="client" width={50} height={50} className="w-8 h-8 xl:w-8 xl:h-8" />
              <p className="text-primary text-3xl font-extrabold mt-3 mb-3">+300</p>
              <p className="text-black font-medium text-sm ">CLIENTI SODDISFATTI</p>
            </div>
            ...
            <div className="mx-auto bg-white px-20 lg:w-[255px] h-[170px] shadow-lg border rounded-xl flex flex-col items-center text-center">
              <Image src={star} alt="star" width={50} height={50} className="mt-3 lg:mt-3 w-14 h-14 xl:w-20 xl:h-w-20" />
              <p className="text-primary text-3xl font-extrabold mt-0 ml-4">1°</p>
              <p className="text-black font-medium text-sm mt-2">MARKETPLACE DI NOLEGGIO</p>
            </div>
            {/* MARKETPLACE DI NOLEGGIO */}
            <div className="bg-white px-20 lg:w-[255px] h-[170px] shadow-lg border rounded-xl flex flex-col items-center text-center p-3 space-y-1">
              <Image src={car} alt="car" width={50} height={50} className="w-14 h-14" />
              <p className="text-primary text-3xl font-extrabold mb-3">+500</p>
              <p className="text-black font-medium text-sm mb-6">NOLEGGI CONCLUSI</p>
            </div>
          </div>
        </div>
      </div>
