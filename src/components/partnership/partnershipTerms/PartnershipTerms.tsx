    ...
    <div id="partnership-termini-e-condizioni" className="container mx-auto">
      ...
      <div className="flex flex-col md:flex-row gap-4 justify-between">
        <header className="w-full md:max-w-2xl text-start md:mb-16">
          <div className="flex flex-col gap-4">
            ...
            <h1 className="text-2xl md:text-[30px] font-extrabold">
              Politiche <br />
              <span className="text-red">termini e condizioni</span>
            </h1>
          </div>
        </header>
        ...
        <Link
          ...
          className="text-sm font-semibold text-red uppercase hidden md:flex items-center gap-1 hover:bg-red/5 px-3 py-2 rounded-lg h-8 mt-[60px]"
        >
        ...
        <div className="flex justify-between overflow-x-auto scrollbar-hide gap-6 xl:gap-40 ">
          ...
          <div className="min-w-[300px] w-full pr-10 flex flex-col items-start text-start">
            ...
            <p className="min-w-48 text-text_light_gray font-medium text-sm ">
              Non addebitiamo alcuna commissione <br /> aggiuntiva per il
              servizio
            </p>
          </div>
          {/* COLLABORAZIONE  */}
          <div className="min-w-[300px] w-full pr-10 flex flex-col items-start text-start">
            ...
            <p className="min-w-48 text-text_light_gray font-medium text-sm ">
              Stipuliamo un accordo di partnership con <br /> ogni azienda di
              noleggio veicoli inserita <br /> sulla nostra piattaforma
            </p>
          </div>
          {/* PRIVACY  */}
          <div className="min-w-[400px] w-full pr-0 md:pr-10 flex flex-col items-start text-start">
            ...
            <p className="min-w-48 text-text_light_gray font-medium text-sm ">
              Proteggiamo i tuoi dati personali nel <br /> rispetto delle
              normative vigenti, assicurando <br /> sicurezza e riservatezza
            </p>
          </div>
        </div>
      </div>
      <Link
        href="/terms-condition"
        className="md:hidden text-sm font-semibold text-red uppercase flex items-center justify-between shadow border-opacity-55 gap-1 hover:bg-red/5 px-16 py-6 rounded-lg h-8 mt-[60px] "
      >
        VEDI TERMINI E CONDIZIONI
        <MdArrowForwardIos />
      </Link>
