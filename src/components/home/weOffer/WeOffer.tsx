...
const features = [
  {
    ...
    description:
      "Siamo al tuo servizio per risolvere ogni tua esigenza con professionalità, cortesia e massima attenzione al cliente.",
  },
  {
    src: icon2,
    title: "Prenotazione facile",
    description:
      "Scegli il veicolo, conferma e parti in pochi click. Un noleggio comodo e senza complicazioni.",
  },
  {
    src: icon3,
    title: "Prezzi eccellenti",
    description:
      "Garantiamo tariffe competitive e accessibili, per offrirti il miglior rapporto qualità-prezzo.",
  },
  {
    src: icon4,
    title: "Staff professionale",
    description:
      "ll nostro team di professionisti esperti è pronto a consigliarti il veicolo più adatto alle tue esigenze.",
  },
  {
    src: icon5,
    title: "Affidabili",
    ...
    <div className="container mx-auto">
      <div className="flex items-center justify-between ">
        <div className="max-w-[450px]">
          <SectionHeader2
            topText="PERCHE SCEGLIERCI"
            title="Offriamo le"
            highlightedText="migliori esperienze"
            remainingText="di noleggio"
          />
        </div>
      ...
      <Link
        href="/benefici"
        className="text-sm font-semibold text-red uppercase flex md:hidden mx-auto  text-center w-full items-center justify-center gap-10 shadow-md px-16 py-6 rounded-lg h-8"
      >
        TUTTI I BENEFICI
        <MdArrowForwardIos />
      </Link>
