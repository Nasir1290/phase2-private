...
const HomeFaq = () => {
  const faqData = [
    ...
    {
      question: "Chi mi contatterà dopo aver inviato una richiesta di noleggio?",
      answer:
    ...
    {
      question: "Come posso contattare l’autonoleggio per ulteriori informazioni?",
      answer: "Puoi contattare l’autonoleggio compilando l’apposito form di contatto o cliccando sul pulsante 'Contatta' all’interno dell’annuncio.",
    },
    {
    ...
    <div id="faq" className="container mx-auto">
      <div className="grid grid-cols-5 gap-5 md:gap-10 2xl:gap-32">
        <div className="col-span-5 xl:col-span-2 space-y-6">
          <div>
            <SectionHeader2 title="Ottieni maggiori informazioni" highlightedText="su Bittengo.org" topText="DOMANDE" />
          </div>
          <Link href="/contatti">
