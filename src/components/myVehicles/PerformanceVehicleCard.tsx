...
const PerformanceVehicleCard: React.FC<VehicleCardProps> = ({ id, mainImage, model, brand, description, acceptanceStatus, carStatus, price }) => {
    ...
    <div className="w-full">
      ...
      >
        ...
        <div className="w-full flex flex-col items-start gap-2.5 pl-7 pr-8 py-5">
          ...
          {/* <Separator /> */}
          <div className="border border-b w-full max-w-3xl text-text_light_gray"></div>
...
export default PerformanceVehicleCard;
