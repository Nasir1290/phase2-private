    ...
    <div className="">
      ...
      <div className="mb-12">
        <div className="flex justify-between items-start mb-6">
          <div>
            <h2 className="text-2xl font-semibold text-gray-900 mb-2">Annunci</h2>
            <p className="text-text_light_gray text-sm">Promuovi i tuoi annunci e raggiungi più visibilità e clienti</p>
          </div>
        ...
        <div className="grid grid-cols-2 gap-y-8 gap-x-16">
          ...
          <div className="bg-white rounded-xl shadow-lg px-6 py-4 border border-black/5 shadow-black/10">
            <div className="flex justify-between items-center">
              <div>
                <h3 className="text-[#AAAAAA] font-medium text-sm ">Annunci di noleggio attivi</h3>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-lg px-6 py-4 border border-black/5 shadow-black/10">
            <div className="flex justify-between items-center">
              <div>
                <h3 className="text-[#AAAAAA] font-medium text-sm ">Annunci in cima</h3>
              </div>
              <div className="flex items-center space-x-2">
                <span className="text-2xl font-bold text-gray-900">0/15</span>
                {/* <Info className="w-5 h-5 text-gray-400" /> */}
                <Image src={cima} alt="Cima Icon" className="w-5 h-5 text-gray-400" />
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg px-6 py-4 border border-black/5 shadow-black/10">
            <div className="flex justify-between items-center">
              <div>
                <h3 className="text-[#AAAAAA] font-medium text-sm">Annunci in homepage</h3>
              </div>
              <div className="flex items-center space-x-2">
                <span className="text-2xl font-bold text-gray-900">0/15</span>
                
                <Image src={home} alt="Home Icon" className="w-5 h-5 text-gray-400 mb-[2px]" />
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg px-6 py-4 border border-black/5 shadow-black/10">
            <div className="flex justify-between items-center">
              <div>
                <h3 className="text-[#AAAAAA] font-medium text-sm">Annunci in risalto</h3>
              </div>
              <div className="flex items-center space-x-2">
                <span className="text-2xl font-bold text-gray-900">0/15</span>
                {/* <Diamond className="w-5 h-5 text-gray-400" /> */}
                <Image src={risalto} alt="Risalto Icon" className="w-5 h-5 text-gray-400" />
              </div>
            </div>
          </div>
        </div>
      ...
      <div>
        <div className="flex justify-between items-start mb-6 mt-24">
          <div>
            <h2 className="text-2xl font-semibold text-gray-900 mb-2">Dati di fatturazione</h2>
            <p className="text-text_light_gray text-sm">Modifica o aggiorna i dati di fatturazione</p>
          </div>
        ...
        <div className="bg-white rounded-lg  border-gray-200 py-6">
          <div className="flex items-start space-x-4">
            ...
            <div>
              <h3 className="font-semibold text-gray-900 text-lg mb-1">Bittengo SAGL</h3>
