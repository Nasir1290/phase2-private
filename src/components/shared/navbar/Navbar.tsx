          ...
          >
            {navLinks.map((link, index) => (
              ...
              >
                <Link
                  href={link.path}
                  className="xl:font-medium text-base xl:text-base hover:text-red transition"
                >
                  {link.label}
                </Link>
              </motion.li>
                      ...
                      {token ? (
                        <div className="flex flex-col items-start">
                          ...
                          <Link
                            ...
                            className="w-full text-right text-sm px-4 py-2 hover:bg-red/5 rounded font-normal flex items-center gap-3"
                          >
                            <Image
                              src={profile}
                              alt="profile icon"
                          ...
                          <Link
                            href="/partnership"
                            onClick={() => setIsOpen(false)}
                            className="w-full text-right text-sm px-4 py-2 hover:bg-red/5 rounded font-normal flex items-center gap-2"
                          >
                            <Image
                              src={partnership}
            ...
            <ul className="flex flex-col gap-4">
              {navLinks.map((link, index) => (
                ...
                >
                  <Link
                    href={link.path}
                    className="hover:text-red transition px-2 font-medium text-[15px]"
                    onClick={toggleMobileMenu}
                  >
                    {link.label}
                  </Link>
