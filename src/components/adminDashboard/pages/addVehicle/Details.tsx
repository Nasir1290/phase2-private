      ...
      <div className="flex flex-wrap items-center justify-start gap-10">
        ...
        <div className="relative flex flex-col gap-3">
          ...
          <Input
            ...
            onChange={(e) => {
              const maxSpeedValue = e.target.value ? Number(e.target.value) : "";
        ...
        <div className="relative flex flex-col gap-3">
          ...
          <Input
            ...
            onChange={(e) => {
              const horsePowerValue = e.target.value ? Number(e.target.value) : "";
        ...
        <div className="relative flex flex-col gap-3">
          ...
          <select
            ...
            onChange={(e) => {
              const selectedSeats = e.target.value ? Number(e.target.value) : "";
