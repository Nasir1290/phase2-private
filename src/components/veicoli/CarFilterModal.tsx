    ...
    >
      <div className="bg-white rounded-lg md:p-4">
        ...
        <div className="">
              ...
              {vehicleCategories.map((category) => (
                <button
                  ...
                  className={` flex flex-col items-center justify-center p-3 rounded-lg border transition-all ${
                    selectedCategory === category.id ? "border-red-500 bg-red-50" : "border-gray-200 bg-white hover:border-gray-300"
                  }`}
                >
                  <div className="w-16 h-6 mb-2 flex items-center justify-center">
                    ...
                    <img
                      ...
                      alt={category.name}
                      className={`w-28 h-auto ${selectedCategory === category.id ? "text-red-500" : "text-gray-600"}`}
                    />
                  </div>
                  <span className={`text-xs text-center leading-tight ${selectedCategory === category.id ? "text-red-500" : "text-gray-600"}`}>
                    {category.name}
                  </span>
                </button>
              ))}
          ...
          <div className="mb-8">
            ...
            <Select
              ...
              className="w-full"
              size="large"
              suffixIcon={<span className="text-gray-400"><IoIosArrowDown /></span>}
              style={{ height: "48px" }}
            >
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                ...
                className={`flex items-center justify-center gap-3 p-3 rounded-lg border transition-all shadow-md ${
                  withDeposit ? "border-red-500 bg-red-50 text-red-500" : "border-gray-200 bg-white hover:border-gray-300 text-gray-700"
                }`}
              >
                <img src={ConDeposito.src} alt="Con deposito" className={`w-5 h-auto `} />
                <p className="text-sm ">Con deposito</p>
              </button>
              <button
                onClick={() => setWithoutDeposit(!withoutDeposit)}
                className={`flex items-center justify-center gap-3 p-3 rounded-lg border transition-all shadow-md ${
                  withoutDeposit ? "border-red-400 bg-red-50 text-red-500" : "border-gray-200 bg-white hover:border-gray-300 text-gray-700"
                }`}
              >
                <img src={ConDeposito.src} alt="Con deposito" className={`w-5 h-auto `} />
              ...
              {["Benzina", "Diesel", "Elettrico", "Ibrido"].map((fuel) => (
                <button
                  ...
                  className={`p-3 rounded-lg border text-sm transition-all shadow-md ${
                    selectedFuel === fuel ? "border-red-500 bg-red-50 text-red-600" : "border-gray-200 bg-white text-gray-700 hover:border-gray-300"
                  }`}
                >
                  {fuel}
                </button>
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                <img src={menual.src} alt="menual" className={`w-5 h-auto `} />
                Manuale
              </button>
              <button
              ...
              >
                <img src={automatic.src} alt="automatic" className={`w-5 h-auto `} />
                Automatico
              </button>
            </div>
          </div>
        ...
        <div className="flex justify-between items-center  pt-4 md:pt-8 border-t border-gray-100">
          ...
          <Button onClick={handleApply} className="bg-red-500 hover:bg-red-600 border-red-500 hover:border-red-600 text-white sm:px-12" size="large">
            Applica
          </Button>
        </div>
      </div>
