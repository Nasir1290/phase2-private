...
import icon2 from "@/assets/vehicle/whatsapp.svg";
...
const ContactModal: React.FC<ContactModalProps> = ({
  ...
  return (
    <div
      className="fixed inset-0 bg-footer_bg bg-opacity-50 flex justify-center items-center z-50"
      onClick={toggleModal}
    >
      <div
        className="bg-white p-8 rounded-lg w-[450px] mx-auto relative"
        onClick={(e) => e.stopPropagation()}
      >
        <button
          onClick={toggleModal}
          className="absolute top-3 right-5 text-2xl  text-text_light_gray hover:text-red"
        >
          &times;
        </button>
        ...
        <div className="flex flex-col items-center gap-3">
          <h2 className="text-[22px] font-semibold text-center">
            Scegli un canale di contatto
          </h2>
          <p className="text-text_light_gray text-[13px] font-medium">
            seleziona un metodo per noleggiare il veicolo
          </p>
